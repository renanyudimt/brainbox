...
import ArrowRight from "@src/assets/icons/light/arrow-right.svg";
    ...
    <Flex flex={1}>
      <Flex flexDir="column" gap={6}>
        <Flex justifyContent="flex-end" flexDir="row" px={"46px"} pt={"42px"}>
          <Link to="/chat">
            <Button variant="unstyled" color="#d7d7d7" fontSize={18}>
              Skip
            </Button>
          </Link>
        </Flex>
                  ...
                  >
                    <Flex w="100%" align="center" justify="center" p={12}>
                      <Image
                        ...
                        objectFit="cover"
                        borderRadius={33}
                        boxShadow="7px 7px 15px rgba(0, 0, 0, 0.25), -7px 7px 15px rgba(0, 0, 0, 0.25), 0px 10px 20px rgba(0, 0, 0, 0.25)"
                      />
                    </Flex>
                  </Flex>
                ))}
